...
interface UserRepository {
    ...
    suspend fun add(user: UserRequest): Result<Int?>
    ...
    suspend fun selectAll(pager: Pager): Result<List<ResultRow>>
...
class UserRepositoryImpl(private val dbTransaction: DbTransaction) : UserRepository {
    ...
    override suspend fun add(user: UserRequest): Result<Int?> {
    ...
    override suspend fun selectAll(pager: Pager): Result<List<ResultRow>> {
        return dbTransaction.dbQuery {
            resultOf {
